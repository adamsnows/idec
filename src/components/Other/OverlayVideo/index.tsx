      ...
      {!isPlaying && (
        <>
          ...
          >
            ...
            <div className="flex flex-col absolute start-0 bottom-0 mb-16 ms-20 z-10">
              <p className="font-normal text-4xl text-[#ffcb03]">
                GRUPO EDUCACIONAL
              </p>
              <p className="text-sm lg:text-7xl font-extrabold">CHAVE MESTRA</p>
            </div>
          </div>
        </>
      )}
